...
function Navbar() {
  return (
    <>
      <div
        className="relative flex flex-row gap-10 justify-center align-middle py-8 bg-black text-white z-50 items-center
      "
      >
        <Image
          className="absolute left-10 top-7  w-[160px] h-[40px] md:m-auto"
          src={SkymentorLogo}
          alt="Skymentor Logo"
        />
        <Link href={"/"}>
